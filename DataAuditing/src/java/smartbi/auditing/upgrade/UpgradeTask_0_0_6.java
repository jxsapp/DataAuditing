 ...
 * 知识库升级类
 */
public class UpgradeTask_0_0_6 extends UpgradeTask {
	...
	public boolean doUpgrade(Connection conn, DBType type) {
		...
		try {
			// 增加新的操作权限
			String[][] funcs = new String[][] { { "MANAGE_TOOLKIT_MONITORWORKFLOW", getProperty("MonitorWorkflow") } };
